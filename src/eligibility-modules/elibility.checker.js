...
async function generateAnswer(data) {
  const promt = `As an airline refund specialist, You determine eligibility for compensation or refunds based on ${data.airlineName} airline policies, regulations, and user-provided claim information. 
